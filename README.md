...
environment. See the subsections below for descriptions and instructions specific to each folder of this repo (each
folder also contains its own readme with more detailed information).
